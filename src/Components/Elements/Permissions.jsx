            ...
            <div className="container-fluid py-3 ">
                <div className="row pt-4 main-management" >
                    <div className='d-flex justify-content-between'>
                        ...
                        <div>
                            <button type="button" className="btn modal-btn" onClick={handleModal}>
                                Create Permission
                            </button>
                        </div>
                    </div>
            ...
            <div className='modal-dialog'>
              <div className='modal-content'>
                    ...
                    <Row>
                      <Col md={12}>
                        <FloatingLabel controlId='firstName1' label='Name' className='mb-3 title-label'>
                          <Form.Control type='text' placeholder='First Name' onChange={(e) => setPermissionName(e.target.value)} />
                        </FloatingLabel>
                      </Col>
                    </Row>
                  </Form>
                ...
                <div className='modal-footer'>
                  <button type='button' className='btn btn-primary' onClick={handlePermissionNameSubmit}>
                    Submit
                  </button>
                </div>
              </div>
