...
import Dashboarddata from '../Utils/Permission.json'
function Permission({initialMaxRows = 5, initialMaxRow , tableId}) {
                        ...
                        Dashboarddata.map((table, index) => (
                          <tr key={index}>
                            ...
                            <td >
                              ...
                              <button className='btn btn-danger mx-1'>Delete</button></div>
                              </td>
                          </tr>
                        ))
                      }
