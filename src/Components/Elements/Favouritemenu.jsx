        ...
        <div className="card p-4">
              <div className='d-flex justify-content-between'>
                ...
                <div className="btn-group">
                  <IoEllipsisVertical className="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false" />
                  <ul className="dropdown-menu">
                    <li><a className="dropdown-item" href="#">Action</a></li>
                    <li><a className="dropdown-item" href="#">Download PDF</a></li>
                    <li><a className="dropdown-item" href="#">Duplicate Invoice</a></li>
                    <li><a className="dropdown-item draft" href="#">Delete Draft</a></li>
                    <li><hr className="dropdown-divider" /></li>
                    <li><a className="dropdown-item" href="#">Connections</a></li>
                    <li><a className="dropdown-item" href="#">View Customer <GoArrowRight />
                    </a></li>
                  </ul>
                </div>
              </div>
                      ...
                      <td>
                        <div className='d-flex gap-2'>
                          <div className='d-flex align-items-center'>
                            <img src={table['food-pic']} alt="food" className='img-fluid' />
                          </div>
