      ...
      <div className="container-fluid py-3 ">
            ...
            <div className="modal-dialog">
              <div className="modal-content">
                  ...
                  <Form>
                    <Row>
                      <Col md={12}>
                        ...
                        >
                          <Form.Control type="text" name="name" value={formData.name} onChange={handleInputChange} placeholder="First Name" />
                        </FloatingLabel>
                      </Col>
                      <h6>Permissions :</h6>
                      <Col md={12}>
                ...
                <div className="modal-footer">
                  <button type="button" className="btn btn-primary" onClick={handleRolesSubmit}>
                    Save
                  </button>
                </div>
              </div>
        ...
        <div className="row py-3">
          <div className="col-md-12">
            <Userstable tableId="role" tableData={roles} initialMaxRow={10} myModal={getAllPermission} myUserFunction={getAllRoles} tableHeader={['#', 'Role', 'Permission', 'Action']} />
          </div>
        </div>
      </div>
    </div>
