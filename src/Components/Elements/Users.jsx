                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <button type="button" class="btn-close" onClick={handleModal}></button>
                                </div>
                                <div class="modal-body">
                                    <Form>
                                        <Row>
                                            <Col md={6}>
                                                <FloatingLabel controlId="firstName1" label="First Name" className="mb-3 title-label">
                                                    <Form.Control type="text" name='firstName' value={formData.firstName} onChange={handleChange} placeholder="First Name" />
                                                </FloatingLabel>
                                            </Col>
                                            <Col md={6}>
                                                <FloatingLabel controlId="lastName1" label="Last Name" className="mb-3 title-label">
                                        ...
                                        <Row>
                                            <Col md={6}>
                                                <FloatingLabel controlId="email"  label="Email" className="mb-3 title-label">
                                                    <Form.Control type="text" name='email' value={formData.email} onChange={handleChange} placeholder="Email" />
                                                </FloatingLabel>
                                            </Col>
                                            <Col md={6}>
                                                <div >
                                                    ...
                                                    <Button
                                                        ...
                                                        className="password-toggle-btn position-absolute eye" style={{ right: 10, top: 62, border: 'none' }}
                                                    >
                                        ...
                                        <Row>
                                            ...
                                            <Col md={6}>
                                                ...
                                                >
                                                    ...
                                                    {
                                                        Array.isArray(selecteRole) && selecteRole.map((role) => (
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-primary" onClick={handleUserSubmit}>Save</button>
                                </div>
                            </div>
                        </div>
                    </div>
