          ...
          <div className="col-md-8">
            <div className="row">
              ...
              <div className="card  p-3 dashboard-card">
                    ...
                    <div >
                      <span className='percent'>7%</span> <span className='previous'>vs. previous month</span>
                    </div>
              ...
              <div className="card  p-3 dashboard-card">
                    ...
                    <div>
                      <span className='percent'>11%</span> <span className='previous'>vs. previous month</span>
                    </div>
              ...
              <div className="card  p-3 dashboard-card">
                    ...
                    <div>
                      <span className='percent'>3.5%</span> <span className='previous'>vs. previous month</span>
                    </div>
              ...
              <div className="col-md-12">
                <div className="card p-3">
                  ...
                  <button
                    ...
                    className={isButtonActive('one_month') ? 'active' : ''}
                  >
                    1M
                  </button>
                  <button
